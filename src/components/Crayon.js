  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <path d="M3.599 170.596c-.305-.188 28.825 5.379 54.842 5.254 28.418-.136 54.379-6.426 53.976-5.816l.877 325.784-110.489.078.794-325.3z" strokeWidth="3" fill={this.state.fill} stroke={this.state.fill}/>
